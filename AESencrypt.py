...
PassPhrase = "higithubthisisme"#set static pass for now 16 char * 8 bits = 128 bits strength
...
outputhex = ""
# add round key
for y in range(1, (len(message)//16)+2):  # loop to encrypt all parts of the message
    eightbit = message[start:end + 16]
    print("The round key is : %s" % PassPhrase)
